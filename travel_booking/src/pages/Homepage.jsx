		...
		<div className="container">
			...
			<div className="collapse navbar-collapse" id="ftco-nav">
				<ul className="navbar-nav ml-auto">
					...
					<li class="nav-item">
					<Link to={"/login_logout"} className="nav-link">Login/Logout</Link>
    ...
    <div className="hero-wrap js-fullheight" >
		...
		<div className="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
				<div className="col-md-7 ftco-animate">
					<span className="subheading" style={{fontSize:'30px', color: '#f15d30', fontfamily: 'Arizonia, cursive',paddingLeft:'-10px'}}>Welcome to Oceans</span>
