...
const About = () => {
    ...
    <div className="hero-wrap-abt js-fullheight" style={{backgroundImage:'url(../assets/img/bg_1.jpg)'}}>
		...
		<div className="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
				<div className="col-md-7 ftco-animate">
					<span className="subheading" style={{fontSize:'30px', color: 'blue', fontfamily: 'Arizonia, cursive',paddingLeft:'-10px'}}>Welcome to Oceans</span>
		...
		<div className="container">
			...
			<div className="row">
				<div className="col-md-4 ftco-animate">
					<div className="project-wrap" style={{border:'1px solid black'}} >
